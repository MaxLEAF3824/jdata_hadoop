...
public class UCRunner {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException, URISyntaxException {
        ...
        String countOutputPath = "/output/UserCount/";
        runUserCount(countInputPath, countOutputPath);
    }

    public static void runUserCount(String inputPath, String outputPath) throws IOException, InterruptedException, ClassNotFoundException {
        Configuration conf = new Configuration();
        Job job = Job.getInstance(conf);

        job.setJarByClass(UCRunner.class);
